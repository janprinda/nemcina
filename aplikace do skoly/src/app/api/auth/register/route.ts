...
export async function POST(req: Request) {
  ...
  db.users.push({ id, name: name || null, email, role, passwordHash, birthDate, interests: interests.length ? interests : null, phone, desiredClassCode: (role==='TEACHER' ? null : (joinClass && classCode ? classCode : null)) });
