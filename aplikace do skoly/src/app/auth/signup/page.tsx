    ...
    <div className="w-full">
      ...
      {step === 1 && (
        <div className="space-y-2">
          <input className="input" placeholder="Jméno" value={name} onChange={e=>setName(e.target.value)} />
          <input className="input" placeholder="Email" value={email} onChange={e=>setEmail(e.target.value)} />
          <input className="input" placeholder="Heslo (min 6)" type="password" value={password} onChange={e=>setPassword(e.target.value)} />
          <div className="text-xs muted">Heslo min. 6 znaků.</div>
        </div>
      )}
      {step === 2 && (
